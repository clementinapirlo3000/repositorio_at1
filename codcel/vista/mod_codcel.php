...
$id_del_codcel_antes    = $registro_nivel_existente->id_rrh_codce;
$nombre_codcel_antes    = $registro_nivel_existente->cod_nombr;
$codcel_antes           = $registro_nivel_existente->cod_celul;
...
<body>
<div class="">
 <form id="form" method="post" class="form-horizontal" action="../controlador/mod_codcel_registro.php">
  ...
  <input type="hidden" name="codcel" value="<?PHP echo $codcel_antes; ?>">
  ...
  <div class="row main-login main-center main">
    <div class="col-lg-12">                   
      <div class="form-group">                
        ...
        <div class="form-group validacionn">
          <label class="col-lg-4 control-label text-right">Numero del C&#243;digo</label>
          <div class="col-lg-6">           
            <div class="">                
              <div class="input-group">  
                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-address-card-o" aria-hidden="true"></i></span> 
                  <input type="text" class="form-control" name="numerocel" step="1" min="999999" data-bv-greaterthan-inclusive="false" data-bv-greaterthan-message="El n&#250;mero debe ser superior a 0.000.000" max="9999999" data-bv-lessthan-inclusive="true" data-bv-lessthan-message="La entrada debe ser inferior a 9.999.999" value="<?PHP echo $codcel_antes; ?>" placeholder="C&#243;digo"/>
              </div>                        
            </div>                         
          </div>
        </div>                              
...
////// Se registra en la bitacora la acción del usuario             //
  ...
  $descripcion_tabla = "rrh_codcel";
  $descripcion_ejecucion = "mod_codcel.php";
  ...
  $objeto_bitacora = "SOLICITAR DATOS DEL CODIGO CELULAR";
  $datos_anteriores = "CODIGO CELULAR A SER MODIFICADO: ".$id_del_codcel_antes." NOMBRE: ".$nombre_codcel_antes." NUMERO: ".$codcel_antes;
