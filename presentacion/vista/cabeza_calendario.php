...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?PHP echo $_SESSION['ruta$nom_proyec']; ?>bootstrap-3.3.7/dist/css/bootstrap.css">
      <!-- Website CSS style -->
  <link rel="stylesheet" type="text/css" href="<?PHP echo $_SESSION['ruta$nom_proyec']; ?>bootstrap-3.3.7/dist/css/formulario.css">
      <!-- Website Font style -->
  ...
  <link rel="stylesheet" href="<?PHP echo $_SESSION['ruta$nom_proyec']; ?>bootstrap-3.3.7/dist/css/bootstrapValidator.css"/>