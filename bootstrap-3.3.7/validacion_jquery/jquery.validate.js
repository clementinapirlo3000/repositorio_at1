...
$.extend($.validator, {
	...
	messages: {
		...
		email: "Por favor coloque un E-mail valido.",
		url: "Por favor coloque URL valida.",
		date: "Por favor coloque una fecha valida.",
		dateISO: "Please enter a valid date (ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "Por favor coloque un número valido.",
