...
$id_del_codcel_antes    = $registro_nivel_existente->id_rrh_testb;
$nombre_codcel_antes    = $registro_nivel_existente->tes_nombre;
...
<body>
<div class="">
 <form id="form" method="post" class="form-horizontal" action="../controlador/mod_establecimientos_registro.php">
      ...
      <div class="form-group">                
          <div class="row"> 
            <div class="form-group validacionn">
              <label class="col-lg-4 control-label text-right">Nombre Establecimiento</label>
              <div class="col-lg-6">
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="col-lg-3 text-left">
                <button type="button" onClick="document.location.href='../controlador/consulta_establecimientos.php';" class="btn btn-warning btn-lg btn-block">Regresar</button>
              </div>
              <div class="col-lg-3 text-right"></div>
            </div>
          </div> 
...
////// Se registra en la bitacora la acción del usuario             //
  ...
  $descripcion_ejecucion = "mod_establecimientos.php";
  ...
  $objeto_bitacora = "SOLICITAR DATOS DEL ESTABLECIMIENTOS";
  $datos_anteriores = "ESTABLECIMIENTOS A SER MODIFICADO: ".$id_del_codcel_antes;
