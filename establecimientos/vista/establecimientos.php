<?php 
/**
  * Nombre: establecimientos.php
  * Autor: Ing: Fernando Paez Acero
  * Autor: Ing: Alex Castro
  * Autor: Ing: Carlos Chacon
  * Acces public
  * Copyleft: 2017
  * Formulario para el ingreso de los establecimientos
  *
**/
...
<body>
<div class="">
  <form id="form" method="post" class="form-horizontal" action="../controlador/establecimientos_registro.php">
        ...
        <div class="form-group">                
          <div class="row"> 
            <div class="form-group validacionn">
              <label class="col-lg-4 control-label text-right">Establecimientos</label>
              <div class="col-lg-6">
...
$(document).ready(function() {  
  $('#empresacel').blur(function(){
    ...
    $.ajax({
            type: "POST",
            url: "../controlador/establecimientos_disponible.php",
            data: dataString,
...
////// Se registra en la bitacora la acción del usuario             //
  ...
  $descripcion_ejecucion = "establecimientos.php";
  $movimiento_bitacora = $_SESSION['idusuarios$nom_proyec'].' '.$_SESSION['idusuarios$nom_proyec'].' '.$_SESSION['idusuarios$nom_proyec'].'...'."ENTRO CARGA DE ESTABLECIMIENTOS";
