<?php 
/**
  * Nombre: estblecimientos_registro.php
  * Autor: Ing: Fernando Paez Acero
  * Autor: Ing: Alex Castro
  * Autor: Ing: Carlos Chacon
  * Acces public
  * Copyleft: 2017
  * Formulario para el ingreso de establecimientos
  *
**/
...
<?php	
  ...
  $insertar_usuario = "INSERT INTO rrh_testb (tes_nombre, fk_id_rrh_estat) VALUES ('$empresacel', 1)";
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="col-lg-2 text-right col-lg-offset-3">
          <button type="submit" class="btn btn-success btn-lg btn-block" onClick="document.location.href='../vista/establecimientos.php';">Registrar Otro</button>
        </div>
        <div class="col-lg-2 text-left">
          <button type="button" onClick="document.location.href='consulta_establecimientos.php';" class="btn btn-warning btn-lg btn-block">Regresar</button>
        </div>
        <div class="col-lg-2 text-left">
...
require ("../../bitacora/vista/bitacora.php");
  ...
  $descripcion_ejecucion = "establecimientos_registro.php";
  $movimiento_bitacora = $_SESSION['idusuarios$nom_proyec'].' '.$_SESSION['nombre1$nom_proyec'].' '.$_SESSION['apellido1$nom_proyec'].'...'."ENTRO AL REGISTRO DE ESTABLECIMIENTOS";
  $objeto_bitacora = "INSERTO LOS DATOS ESTABLECIMIENTOS";
