<?php 
/**
  * Nombre: mod_establecimientos_registro.php
  * Autor: Ing: Fernando Paez Acero
  * Autor: Ing: Alex Castro
  * Autor: Ing: Carlos Chacon
  * Acces public
  * Copyleft: 2017
  * Formulario para el Modificar los establecimientos
  *
**/
...
<?php 
  ...
  $insertar_usuario = "UPDATE rrh_testb SET tes_nombre = '$empresacel' WHERE id_rrh_testb = $id_del_codcel";
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="col-lg-2 text-right col-lg-offset-4">
          <button type="submit" class="btn btn-success btn-lg btn-block" onClick="document.location.href='consulta_establecimientos.php';">Modificar Otro</button>
        </div>
...
////// Se registra en la bitacora la acción del usuario             //
  ...
  $movimiento_bitacora = $_SESSION['idusuarios$nom_proyec'].' '.$_SESSION['nombre1$nom_proyec'].' '.$_SESSION['apellido1$nom_proyec'].'...'."MODIFICO ESTABLECIMIENTOS";
  $objeto_bitacora = "INSERTO LOS DATOS DEL ESTABLECIMIENTOS";
  $datos_anteriores = "ESTABLECIMIENTOS: ".$nombre_codcel_bitacoral_antes;
  $datos_nuevos = "ESTABLECIMIENTOS: ".$empresacel_bitacora_despues;
