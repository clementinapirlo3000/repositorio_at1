...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `Provincia` varchar(32) collate latin1_general_ci default NULL,
...
INSERT INTO `zoom`.`pais` (`Nombre` ,`Codigo` ,`Capital` ,`Provincia` ,`Area` ,`Poblacion`) VALUES
...
('Andorra', 'AND', 'Andorra nombre Vella', 'Andorra', 450, 72766),
