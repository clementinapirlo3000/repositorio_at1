...
CREATE TABLE IF NOT EXISTS `Ciudad` (
  ...
  `Pais` varchar(4) collate latin1_general_ci NOT NULL,
  `Poblacion` int(11) default NULL,
  `Area` int(11) default NULL,
  `Capital` varchar(35) collate latin1_general_ci default NULL,
  `CapCiudad` varchar(32) collate latin1_general_ci default NULL,
...
INSERT INTO `zoom`.`ciudad` (`Nombre`, `Pais`, `Poblacion`, `Area`, `Capital`, `CapCiudad`) VALUES
