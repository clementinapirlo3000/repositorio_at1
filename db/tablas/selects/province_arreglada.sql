INSERT INTO lab_provin (pro_nombr, pro_pais, pro_pobla, pro_area, pro_capit, pro_capro) VALUES
...
UPDATE lab_ciuda AS c SET fk_id_lab_provin=(SELECT id_lab_provin FROM lab_provin WHERE c.ciu_pais = pro_pais AND c.ciu_provi = pro_nombr);
SELECT * FROM lab_ciuda WHERE fk_id_lab_provin=1119;
UPDATE lab_provin AS p SET fk_id_lab_pais=(SELECT id_lab_pais FROM lab_pais WHERE p.pro_pais = pai_codig);